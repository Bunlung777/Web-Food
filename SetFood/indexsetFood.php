        ...
        <div class="relative w-full max-w-lg max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mt-4 -mb-3">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <hr>
                    <form class="space-y-6" action="insertSetFood.php" method="post" enctype="multipart/form-data">
                        <div>
...
<div class="flex flex-col mt-6 container">
        ...
        <tbody>
            ...
            if (isset($_POST['search'])){//ถ้าไม่มีข้อมูลใน user
                $search = $_POST['search'];
                $query = $conn->query("SELECT * FROM setfood WHERE SetName LIKE '%$search%' ");
                $query -> execute();
        ...
        //ถ้าไม่มีข้อมูลใน user
                ...
                <td><?php echo '<img src="data:image/jpeg;base64,'.base64_encode($result['ImgSet']).'" alt="Upload Image"  style="width: 150px; height: 100px" class="rounded-lg images "  "/>' ?></td>
        
                <td class="px-6 py-4 font-normal text-gray-600 "><?php echo $result['VillageSet']; ?></td>
