...
<body>
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="insertFood.php" method="post" enctype="multipart/form-data">
                        <div>
                            ...
                            <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="imgInput" type="file" name="imgSet">
    ...
    <div class="container mt-5">
        ...
        <div class="flex justify-end ">
            <button type="button" class="h-12 px-8 m-2 text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm py-2.5 text-center mr-2 mb-2" data-modal-target="FoodModal" data-modal-toggle="FoodModal">เพิ่มรายการอาหาร</button>
        </div>
...
<div class=" min-w-full sm:px-10 lg:px-11 container ">
    <table class="w-5/6 h-32 mx-auto text-sm text-left text-gray-500 dark:text-gray-400 table-fixed">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
            <div class="">
                <tr>
                    <th scope="col" class="px-6 py-3">Id</th>
                    <th scope="col" class="px-6 py-3">รูปภาพอาหาร</th>
                    <th scope="col" class="px-6 py-3">ชื่ออาหาร</th>
                    <th scope="col" class="px-6 py-3">รายละเอียดอาหาร</th>
                    <th></th>
                </tr>
        </thead>
        <tbody>
            ...
            ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $food['IdFood']; ?></td>
                        <div>
                        ...
                        <td class="px-6 py-4"><?php echo $food['FoodName']; ?></td>
                        <td class="px-6 py-4"><?php echo $food['Detail']; ?></td>
                        <td>
